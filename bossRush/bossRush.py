...
player = Entity(4, 5, 10, 100, "bossRush/sprites/[PH]_player.png", 64, 64) # COMMENT THIS OUT IF RUNNING GAME THROUGH THIS FILE
player.rect.y = 0                                                         # Line 22 intended for Main Menu functionality
player.rect.x = 0
all_sprites.add(player)

# boss = Entity(5100, 10, 0, 1, "sprites/[PH]_boss.png", 256, 256) 
boss = Entity(5100, 10, 0, 1, "bossRush/sprites/[PH]_boss.png", 256, 256) # COMMENT THIS OUT IF RUNNING GAME THROUGH THIS FILE
